...
**All scenarios create the same artifacts**:
- `.github/instructions/inception-application-design.instructions.md`
- `component-diagram.md`

**Detail level varies by complexity**:

### Simple Scenario (Single Component)
- **application-design.instructions.md**: Basic component description, key methods
- **component-diagram.md**: Simple diagram with essential relationships

### Complex Scenario (Multi-Component System)
- **application-design.instructions.md**: Detailed component responsibilities, all methods with signatures, design patterns, alternatives considered
