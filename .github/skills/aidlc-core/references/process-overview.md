...
• **Workspace Detection** (always) → **Reverse Engineering** (brownfield only) → **UI Mockup** (conditional - Web UI) → **Requirements Analysis** (always, adaptive depth) → **Conditional Phases** (as needed) → **Workflow Planning** (always) → **Development Standards** (conditional - multi-unit) → **Code Generation** (always, per-unit) → **Security Check** (recommended) → **Build and Test** (always)
...
• **All other stages are conditional**: Reverse Engineering, UI Mockup, User Stories, Application Design, Units Generation, Development Standards, per-unit design stages (Functional Design, NFR Requirements, NFR Design, Infrastructure Design), Security Check
...
flowchart TD
    ...
    subgraph INCEPTION["🔵 INCEPTION PHASE"]
        ...
        UM["UI Mockup<br/><b>CONDITIONAL</b>"]
        ...
        DS["Development Standards<br/><b>CONDITIONAL</b>"]
    end
    ...
    subgraph CONSTRUCTION["🟢 CONSTRUCTION PHASE"]
        ...
        SC["Security Check<br/><b>RECOMMENDED</b>"]
    ...
    style UM fill:#FFA726,stroke:#E65100,stroke-width:3px,stroke-dasharray: 5 5,color:#000
    ...
    style SC fill:#81C784,stroke:#388E3C,stroke-width:3px,stroke-dasharray: 5 5,color:#000
